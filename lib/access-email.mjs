 ...
 * and neither does the ten-rouble smoke order: /brief is only open to a pilot
 * grant, so sending either there would dead-end the customer.
 */
export function nextStepPath(plan) {
  return plan === "subscription" || plan === "live-smoke" ? "/payment/success" : "/brief";
}
