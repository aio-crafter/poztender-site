      ...
      {buyerType === "business" && (
        <>
          ...
          <p className="field-hint">
            Оплата картой доступна только физическим лицам. Для ИП и организаций мы сформируем
            счёт на банковский перевод — на следующем шаге покажем номер заказа и порядок оплаты.
          </p>
        </>
      )}
    </>
