    ...
    <main>
      ...
      <section className="section shell" id="price">
        <div className="pricing-wrap">
          ...
          <div className="price-card">
            ...
            <p>Физлицам — карта или СБП на защищённой странице, чек НПД приходит автоматически. ИП и организациям — счёт на банковский перевод, чек НПД с вашим ИНН после поступления оплаты. Далее — 7 900 ₽/мес., но только после вашего подтверждения.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section faq-section shell" id="faq">
        ...
        <div className="faq-grid">
          ...
          <article><h3>Как проходит оплата?</h3><p>Физическое лицо платит картой или через СБП прямо на сайте — чек НПД приходит автоматически. ИП и организации платят банковским переводом по счёту: приём таких платежей картой у нас недоступен. После поступления денег на счёт мы формируем чек НПД с вашим ИНН и начинаем калибровку.</p></article>
        </div>
      </section>
