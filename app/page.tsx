    ...
    <main>
      ...
      <section className="section faq-section shell" id="faq">
        ...
        <div className="faq-grid">
          ...
          <article><h3>Как проходит оплата?</h3><p>Мы готовим индивидуальный счёт-оферту. После оплаты от ООО или ИП отправляем чек НПД и начинаем калибровку.</p></article>
        </div>
      </section>
